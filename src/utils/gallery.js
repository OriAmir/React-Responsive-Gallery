import {
  screenWidthSizes, numOfImagesPerRow, imagesMaxWidth, colsPadding, imagesPaddingBottom
...
const isWidthGroupsDifferents = (oldWidth, newWidth, userScreenWidthValues) => getSizeGroup(
  oldWidth, userScreenWidthValues
...
const getGallerySizes = (width, userValues) => {
  ...
  const imagesPaddingBottomValues = userValues && userValues.imagesPaddingBottom;
  let widthSize = 'xxl';
  ...
  return {
    screenWidthSizes: (screenWidthSizesValues && screenWidthSizesValues[widthSize])
      || screenWidthSizes[widthSize],
    numOfImagePerRow: (numOfImagesPerRowValues && numOfImagesPerRowValues[widthSize])
      || numOfImagesPerRow[widthSize],
    imagesMaxWidth: (imagesMaxWidthValues && imagesMaxWidthValues[widthSize])
      || imagesMaxWidth[widthSize],
    colsPadding: (colsPaddingValues && colsPaddingValues[widthSize])
      || colsPadding[widthSize],
    imagesPaddingBottom: (imagesPaddingBottomValues && imagesPaddingBottomValues[widthSize])
...
export {
  getGallerySizes, getSizeGroup, isWidthGroupsDifferents, sortImagesArrayByOrder
};
